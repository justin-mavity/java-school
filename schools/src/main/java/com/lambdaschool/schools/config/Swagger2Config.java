...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("Schools Model Example")
            .description("Schools Model Example")
            .contact(new Contact("Justin Mavity",
                "http://www.lambdaschool.com",
                "justinmavity1021@gmail.com"))
            .license("MIT")
            .licenseUrl("https://github.com/LambdaSchool/java-schools/blob/master/LICENSE")
            .version("1.0.0")
            .build();
    }
}